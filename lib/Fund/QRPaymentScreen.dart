...
class _QRPaymentScreenState extends State<QRPaymentScreen> {
  ...
  late Map<String, String> _apiHeaders;

  final String _api1Url =
      '${Constant.apiEndpoint}deposit-create-upi-fund-request';
  final String _api2Url = '${Constant.apiEndpoint}add-upi-deposit-fund-request';
...
// import 'package:screenshot/screenshot.dart';
// import 'package:url_launcher/url_launcher.dart';
// import 'package:webview_flutter/webview_flutter.dart'; // Revert to webview_flutter
//
// class QRPaymentScreen extends StatefulWidget {
//   final String paymentLink;
//   final String amount;
...
//     registerId = box.read('registerId') ?? '';
//
//     _initializeWebView(); // Initialize the WebView
//   }
//
//   // Initialize the WebViewController for webview_flutter
//   void _initializeWebView() {
