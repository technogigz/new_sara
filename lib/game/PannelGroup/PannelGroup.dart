...
class _PanelGroupScreenState extends State<PanelGroupScreen> {
  // Removed fixed gameTypesOptions list here. It will be generated dynamically.
  ...
  void initState() {
    ...
    // Initialize selectedGameBetType based on widget.selectionStatus
  ...
  void _addEntry() {
    ...
    if (parsedAmount == null ||
        parsedAmount < GetStorage().read('minBid') ||
        parsedAmount > 1000) {
      _showMessage(
  ...
  // Modified _buildDropdown to accept a list of options
