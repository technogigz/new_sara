...
// import '../../components/BidSuccessDialog.dart';
//
// // Removed the duplicate AnimatedMessageBar class definition as it's imported.
//
// class SingleDigitsBulkScreen extends StatefulWidget {
//   final String title;
//   final int gameId;
...
//     ).format(DateTime.now());
//
//     // --- Transformation from Map<String, String> to List<Map<String, String>> ---
//     List<Map<String, String>> bidsForDialog = bidAmounts.entries.map((entry) {
//       return {
//         "digit": entry.key,
//         "points": entry.value,
//         "type": selectedGameType, // Use the dynamically selected game type
//         "pana": "", // pana should be empty for single digits, not entry.value
//       };
//     }).toList();
//     // --- End Transformation ---
//
...
//
//     // --- Transformation from Map<String, String> to List<Map<String, String>> ---
//     // This is crucial for matching the expected type of _bidService.getBidAmounts
//     List<Map<String, String>> formattedBidsForService = bidAmounts.entries.map((
//       entry,
//     ) {
//       return {
...
//         "points": entry.value,
//         "type": selectedGameType, // Use the dynamically selected game type
//         // If your API expects "pana" for single digits, it should be empty or null
//         "pana": "",
//       };
//     }).toList();
//     // --- End Transformation ---
...
//       deviceName: _deviceName,
//       accountStatus: _accountStatus,
//       bidAmounts: bidAmounts, // Pass the correctly formatted list
//       selectedGameType:
//           selectedGameType, // Use the dynamically selected game type
//       gameId: widget.gameId,
//       gameType: widget.gameType,
